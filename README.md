...
#### Download the requirements.txt file here: <a href="https://github.com/arcelioeperez/dash-app/blob/gh-pages/requirements.txt" download="requirements.txt">requirements.txt</a>  
