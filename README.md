...
#### Download the requirements.txt file here: <a href="https://github.com/arcelioeperez/dash-app/blob/main/assets/requirements.txt" download= "requirements.txt">requirements.txt</a>  
