...
Jupyter Notebook Regression: <a href="source/PythonRegression.ipynb">Download PythonRegression.ipynb </a> | View from Broser: [PythonRegression.ipynb](https://github.com/arcelioeperez/dash-app/raw/gh-pages/source/PythonRegression.ipynb)  
